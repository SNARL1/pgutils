...
pg_profiles <- function() {
  list(
    default = list(
      host = "localhost", port = 5432, dbname = "slip", user = "rknapp",
    ...
    slip_eri   = list(
      host = "localhost", port = 25432, dbname = "slip", user = "rknapp",
      schemas = c("public", "reference_collection", "surveys_samples")
    ),
    amphibians_eri = list(
      host = "localhost", port = 25432, dbname = "amphibians", user = "rknapp",
      schemas = c("public", "qpcr_fdw")
    ),
    qpcr_eri = list(
      host = "localhost", port = 25432, dbname = "qpcr", user = "rknapp",
      schemas = c("public")
    ),
    ribbitr = list(
